...
$routes = [
    ...
    'GET /stats/agents/:id/conversion' => ['Api\V1\Controllers\StatsController', 'agentConversion', true],
    'GET /stats/conversion'        => ['Api\V1\Controllers\StatsController', 'conversion',  true],
