    ...
    public function saveConversations(): void
    {
        ...
        try {
            ...
            $settings = [
                ...
                'realtime_coaching' => [
                    'enabled' => isset($data['realtime_coaching']['enabled']) && $data['realtime_coaching']['enabled'],
                    ...
                    'use_queue' => isset($data['realtime_coaching']['use_queue']) && $data['realtime_coaching']['use_queue'],
                    ...
                    'analyze_only_client_messages' => isset($data['realtime_coaching']['analyze_only_client_messages']) && $data['realtime_coaching']['analyze_only_client_messages'],
                    'min_message_length' => isset($data['realtime_coaching']['min_message_length']) ? (int)$data['realtime_coaching']['min_message_length'] : 10,
                    'skip_if_agent_typing' => isset($data['realtime_coaching']['skip_if_agent_typing']) && $data['realtime_coaching']['skip_if_agent_typing'],
                    'use_cache' => isset($data['realtime_coaching']['use_cache']) && $data['realtime_coaching']['use_cache'],
                    ...
                    'hint_types' => [
                        'objection' => isset($data['realtime_coaching']['hint_types']['objection']) && $data['realtime_coaching']['hint_types']['objection'],
                        'opportunity' => isset($data['realtime_coaching']['hint_types']['opportunity']) && $data['realtime_coaching']['hint_types']['opportunity'],
                        'question' => isset($data['realtime_coaching']['hint_types']['question']) && $data['realtime_coaching']['hint_types']['question'],
                        'negative_sentiment' => isset($data['realtime_coaching']['hint_types']['negative_sentiment']) && $data['realtime_coaching']['hint_types']['negative_sentiment'],
                        'buying_signal' => isset($data['realtime_coaching']['hint_types']['buying_signal']) && $data['realtime_coaching']['hint_types']['buying_signal'],
                        'closing_opportunity' => isset($data['realtime_coaching']['hint_types']['closing_opportunity']) && $data['realtime_coaching']['hint_types']['closing_opportunity'],
                        'escalation_needed' => isset($data['realtime_coaching']['hint_types']['escalation_needed']) && $data['realtime_coaching']['hint_types']['escalation_needed'],
                    ],
                    'auto_show_hint' => isset($data['realtime_coaching']['auto_show_hint']) && $data['realtime_coaching']['auto_show_hint'],
                    ...
                    'play_sound' => isset($data['realtime_coaching']['play_sound']) && $data['realtime_coaching']['play_sound'],
                ],
                'agent_performance_analysis' => [
                    'enabled' => isset($data['agent_performance_analysis']['enabled']) && $data['agent_performance_analysis']['enabled'],
                    ...
                    'check_interval_hours' => isset($data['agent_performance_analysis']['check_interval_hours']) ? (int)$data['agent_performance_analysis']['check_interval_hours'] : 24,
                    'max_conversation_age_days' => isset($data['agent_performance_analysis']['max_conversation_age_days']) ? (int)$data['agent_performance_analysis']['max_conversation_age_days'] : 7,
                    ...
                    'min_messages_to_analyze' => isset($data['agent_performance_analysis']['min_messages_to_analyze']) ? (int)$data['agent_performance_analysis']['min_messages_to_analyze'] : 5,
                    'min_agent_messages' => isset($data['agent_performance_analysis']['min_agent_messages']) ? (int)$data['agent_performance_analysis']['min_agent_messages'] : 3,
                    'analyze_closed_only' => isset($data['agent_performance_analysis']['analyze_closed_only']) ? (int)$data['agent_performance_analysis']['analyze_closed_only'] : 1,
                    'dimensions' => isset($data['agent_performance_analysis']['dimensions']) ? $data['agent_performance_analysis']['dimensions'] : [],
                    'gamification' => [
                        'enabled' => isset($data['agent_performance_analysis']['gamification']['enabled']) && $data['agent_performance_analysis']['gamification']['enabled'],
                    ],
                    'coaching' => [
                        'enabled' => isset($data['agent_performance_analysis']['coaching']['enabled']) && $data['agent_performance_analysis']['coaching']['enabled'],
