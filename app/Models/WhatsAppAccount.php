...
class WhatsAppAccount extends Model
{
    ...
    protected array $fillable = ['name', 'phone_number', 'provider', 'api_url', 'api_key', 'instance_id', 'status', 'config', 'quepasa_user', 'quepasa_token', 'quepasa_trackid', 'quepasa_chatid', 'default_funnel_id', 'default_stage_id', 'wavoip_token', 'wavoip_enabled'];
