...
class DashboardService
{
    ...
    /**
     * Obter distribuição de conversas por dia da semana
     */
    public static function getConversationsByDayOfWeek(?string $dateFrom = null, ?string $dateTo = null): array
    {
        $dateFrom = $dateFrom ?? date('Y-m-01');
        $dateTo = $dateTo ?? date('Y-m-d') . ' 23:59:59';
        ...
        // Traduzir nomes dos dias e garantir todos os dias da semana
        $daysMap = [
            1 => 'Domingo',
            2 => 'Segunda',
            3 => 'Terça',
        ...
        foreach ($results as $row) {
            ...
            $data[$dayNum]['total'] = (int)$row['total'];
        }
    ...
    /**
     * Obter distribuição de conversas por hora do dia
     */
    public static function getConversationsByHourOfDay(?string $dateFrom = null, ?string $dateTo = null): array
    {
        $dateFrom = $dateFrom ?? date('Y-m-01');
        $dateTo = $dateTo ?? date('Y-m-d') . ' 23:59:59';
