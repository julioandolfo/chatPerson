...
Router::get('/integrations/notificame/accounts/{id}/discover-channels', [IntegrationController::class, 'discoverNotificameChannels'], ['Authentication']);
...
Router::get('/api4com-calls/analysis/{id}', [Api4ComCallController::class, 'getAnalysis'], ['Authentication']);
Router::post('/api4com-calls/{id}/analyze', [Api4ComCallController::class, 'analyzeCall'], ['Authentication']);
...
Router::get('/goals/my', [\App\Controllers\GoalController::class, 'myGoals'], ['Authentication']);
...
Router::post('/conversation-tabs/update', [TagController::class, 'updateTab'], ['Authentication']);
...
Router::get('/conversation-tabs/funnel-stages', [TagController::class, 'getFunnelStages'], ['Authentication']);
...
Router::post('/campaigns/{id}/restart', [CampaignController::class, 'restart'], ['Authentication']);
