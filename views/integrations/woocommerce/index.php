            ...
            <form id="form_edit_woocommerce" onsubmit="updateIntegration(event)">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-5">
                        <label class="form-label">Meta Key do Vendedor</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="seller_meta_key" id="edit_seller_meta_key" placeholder="_vendor_id">
                            <button type="button" class="btn btn-light-primary" onclick="testSellerMetaKeyEdit()" id="btn_test_meta_key_edit">
                                <i class="ki-duotone ki-verify fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                                </i>
                        ...
                        <div id="test_meta_key_result_edit" class="mt-3" style="display: none;"></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancelar</button>
...
function editIntegration(id, integration) {
    ...
    // Popular campo de seller meta key
    document.getElementById('edit_seller_meta_key').value = integration.seller_meta_key || '_vendor_id';
...
// Testar Meta Key do Vendedor (Modal de Edição)
function testSellerMetaKeyEdit() {
    const metaKey = document.getElementById('edit_seller_meta_key').value;
    const resultDiv = document.getElementById('test_meta_key_result_edit');
    const testBtn = document.getElementById('btn_test_meta_key_edit');
    ...
    // Pegar ID da integração do campo hidden
    const integrationId = document.getElementById('edit_integration_id').value;
    
    if (!integrationId) {
        Swal.fire({
            icon: 'info',
            title: 'Atenção',
            text: 'ID da integração não encontrado'
        });
        return;
    }
