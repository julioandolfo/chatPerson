...
<div class="card">
    ...
    <div class="card-body pt-0">
        <form id="kt_form_kanban_agent">
                ...
                <div class="col-md-6">
                    ...
                    <select name="execution_type" class="form-select" required id="execution_type">
                        <optgroup label="⚡ Instantâneo (por evento)">
                            <option value="instant_client_message">Mensagem do Cliente (Instantâneo)</option>
                            <option value="instant_agent_message">Mensagem do Agente (Instantâneo)</option>
                            <option value="instant_any_message">Qualquer Mensagem (Instantâneo)</option>
                        </optgroup>
            ...
            <div class="row mb-5">
                <div class="col-md-12">
                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" name="working_hours_enabled" id="working_hours_enabled">
            ...
            <div id="working_hours_config" class="d-none">
                <div class="row mb-5">
                    <div class="col-md-6">
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            $defaultDays = [1,2,3,4,5]; // Seg-Sex por padrão
                            foreach ($dayNames as $i => $day): 
                            ?>
                            <div class="form-check">
                                <input class="form-check-input working-day-check" type="checkbox" value="<?= $i ?>" id="working_day_<?= $i ?>" <?= in_array($i, $defaultDays) ? 'checked' : '' ?>>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="time" name="working_start_time" id="working_start_time" class="form-control" value="08:00">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Horário Final</label>
                        <input type="time" name="working_end_time" id="working_end_time" class="form-control" value="18:00">
                    </div>
                </div>
...
function collectActions() {
    ...
    document.querySelectorAll('.action-item').forEach((item, index) => {
        ...
        if (processImmediately && type === 'assign_ai_agent') {
